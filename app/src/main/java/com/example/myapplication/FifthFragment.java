...
public class FifthFragment extends Fragment {
    ...
    Handler helloHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(@NonNull Message msg) {
            binding.textView2.setText(msg.obj.toString());
            return true;
        }
    });
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.floatingActionButton2.setOnClickListener(v -> {
            ...
            repo.hello(application.getSrv(), helloHandler);
            repo.postComment(application.getSrv(), helloHandler,comment,"CS310","Mobile Application Development");
        });
