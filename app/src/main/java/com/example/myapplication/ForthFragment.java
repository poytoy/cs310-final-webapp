...
import com.example.myapplication.databinding.FragmentForthBinding;
...
public class ForthFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.floatingActionButton2.setOnClickListener(v -> {
            ...
            repo.postComment(application.getSrv(), helloHandler,comment,"CS303","Logic&Digital System Design");
        });
